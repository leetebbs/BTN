...
uint256 hashGenesisBlock("0x3c22015babd519b5eae17ceda69baf445c99aafbc3afca1ade17de6232f75c88");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Bostoncoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Bostoncoin Signed Message:\n";
...
{
    // Bostoncoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Bostoncoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Bostoncoin: 3.5 days
static const int64 nTargetSpacing = 150; // Bostoncoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Bostoncoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Bostoncoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Bostoncoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4730bd0b55c46a07ba182766647626bc79cdbef8bd7e82d6e899f48b9f8937e5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("e8ba0e052defbdf1a8204975feda1ec3038d039b56ce5b7a592ed9c9976791eed48fada15c81869ddc9790324bdb43b3d097a48a3eba517512f0f0dc41dff79334") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1433700959;
        ...
        assert(block.hashMerkleRoot == uint256("0xa877f81e516b4c4003d779b308cc2054942fbf13cf565224d47e9f30c53d0b93"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Bostoncoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BostoncoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BostoncoinMiner : ProcessBlock, block not accepted");
    }
